...
P2 = P1; %Set same transmit power range at relay 1
...
% Throughput 
th_nonideal_af_f = r*(1-OP_nonideal_af_f/nbrOfIterations);
th_nonideal_af_v = r*(1-OP_nonideal_af_v/nbrOfIterations);
th_nonideal_df = r*(1-OP_nonideal_df /nbrOfIterations);

th_nonideal_af_f(:,2) = r*(1-OP_nonideal_af_f/nbrOfIterations);
th_nonideal_af_v(:,2) = r*(1-OP_nonideal_af_v/nbrOfIterations);
th_nonideal_df(:,2) = r*(1-OP_nonideal_df /nbrOfIterations);
...
plot(kappaRange,th_nonideal_af_f(:,1),'k','LineWidth',1);
plot(kappaRange,th_nonideal_af_v(:,1),'b--','LineWidth',1);
plot(kappaRange,th_nonideal_df(:,1),'r-.','LineWidth',1);
...
plot(kappaRange,th_nonideal_af_f(:,2),'k','LineWidth',1);
plot(kappaRange,th_nonideal_af_v(:,2),'b--','LineWidth',1);
plot(kappaRange,th_nonideal_df(:,2),'r-.','LineWidth',1);
